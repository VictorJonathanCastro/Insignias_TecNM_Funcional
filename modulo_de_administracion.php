        ...
        <div style="position: relative; flex: 1; min-width: 120px;">
          ...
          <div id="dropdown-mas-opciones" style="display: none; position: absolute; top: 100%; left: 0; min-width: 280px; background: #1e3a5f; color: white; border-radius: 8px; box-shadow: 0 8px 24px rgba(0,0,0,0.25); z-index: 10001; margin-top: 4px; overflow: hidden;">
            ...
            <div style="padding: 8px 0;">
              <div class="mas-opciones-fila" style="display: flex; align-items: center; padding: 12px 16px; border-bottom: 1px solid rgba(255,255,255,0.1); cursor: pointer;" onclick="cerrarDropdownMasOpciones(); mostrarTabOpciones('tab-certificados');" title="Abrir gestión de Certificados">📄 Certificados</div>
              <div class="mas-opciones-fila" style="display: flex; align-items: center; padding: 12px 16px; cursor: pointer;" onclick="cerrarDropdownMasOpciones(); mostrarTabOpciones('tab-insignias-otorgadas');" title="Abrir gestión de Insignias Otorgadas">🎖️ Insignias Otorgadas</div>
            </div>
          </div>
        </div>
      </div>
