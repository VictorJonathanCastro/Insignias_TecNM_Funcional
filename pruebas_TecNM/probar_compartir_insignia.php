...
echo "<h2>🧪 Probar compartir insignia</h2>";
...
if ($result && $result->num_rows > 0) {
    ...
    if (file_exists($image_path)) {
        ...
        // Generar URLs
        $share_url = $base_url . '/compartir_insignia.php?codigo=' . urlencode($codigo_buscar);
        ...
        echo "<ul>";
        echo "<li><a href='$share_url' target='_blank'>compartir_insignia.php (NUEVO)</a></li>";
        ...
        echo "<ol>";
        echo "<li>Verifica que la imagen sea accesible: <a href='$image_url' target='_blank'>$image_url</a></li>";
        echo "<li>Usa el Facebook Debugger para verificar los meta tags</li>";
        echo "<li>Forza la actualización de caché en Facebook</li>";
        echo "<li>Espera unos minutos para que Facebook actualice</li>";
        echo "</ol>";
...
echo "<li>Usa el enlace de 'compartir_insignia.php' (NUEVO)</li>";
