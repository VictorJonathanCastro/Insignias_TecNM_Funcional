...
echo "<h2>🔧 Solución SSL Error - Alternativa con localtunnel</h2>";

$codigo_buscar = 'TecNM-ITSM-20251-116';

echo "<p><strong>Problema:</strong> serveo tiene error SSL (ERR_SSL_PROTOCOL_ERROR)</p>";
...
if ($result && $result->num_rows > 0) {
    ...
    if (file_exists($image_path)) {
        ...
        echo "<h3>🔧 Solución con localtunnel:</h3>";
        ...
        echo "<br>";
        echo "<h4>Paso 5: Usar la URL con localtunnel</h4>";
        ...
        echo "<h4 style='color: #155724; margin: 0;'>✅ SISTEMA LISTO PARA LOCALTUNNEL</h4>";
        echo "<p style='color: #155724; margin: 10px 0 0 0;'>El sistema está preparado para funcionar con localtunnel. Una vez configurado, Facebook podrá acceder a la imagen sin errores SSL.</p>";
        echo "</div>";
...
echo "<li>Instala Node.js y configura localtunnel (más estable que serveo)</li>";
echo "<li>Usa la URL de localtunnel para compartir en Facebook</li>";
echo "<li>Facebook podrá acceder a la URL pública sin errores SSL</li>";
echo "</ol>";
?>
