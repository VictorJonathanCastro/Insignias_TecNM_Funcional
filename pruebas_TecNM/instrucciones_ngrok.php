...
echo "<h2>🚀 Solución ngrok para Facebook</h2>";
...
if ($result && $result->num_rows > 0) {
    ...
    if (file_exists($image_path)) {
        ...
        echo "<h3>🔧 Instrucciones para configurar ngrok:</h3>";
        echo "<div style='background: #e3f2fd; padding: 20px; border-radius: 10px; margin: 20px 0; border-left: 4px solid #2196f3;'>";
        echo "<h4>Paso 1: Descargar ngrok</h4>";
        echo "<p>Ve a <a href='https://ngrok.com/' target='_blank'>https://ngrok.com/</a> y descarga ngrok para Windows.</p>";
        echo "<br>";
        echo "<h4>Paso 2: Extraer ngrok</h4>";
        echo "<p>Extrae el archivo ngrok.exe en una carpeta (ej: C:\\ngrok\\)</p>";
        echo "<br>";
        echo "<h4>Paso 3: Ejecutar ngrok</h4>";
        ...
        echo "</div>";
        echo "<br>";
        echo "<h4>Paso 4: Copiar la URL de ngrok</h4>";
        echo "<p>ngrok mostrará algo como:</p>";
        echo "<div style='background: #f8f9fa; padding: 10px; border-radius: 5px; font-family: monospace; margin: 10px 0;'>";
        echo "Forwarding    https://abc123.ngrok.io -> http://localhost:80";
        echo "</div>";
        echo "<p>Copia la URL: <strong>https://abc123.ngrok.io</strong></p>";
        echo "<br>";
        echo "<h4>Paso 5: Usar la URL con ngrok</h4>";
        echo "<p>Usa esta URL en tu navegador:</p>";
        echo "<div style='background: #f8f9fa; padding: 10px; border-radius: 5px; font-family: monospace; margin: 10px 0;'>";
        echo "https://abc123.ngrok.io/Insignias_TecNM_Funcional/facebook_ngrok.php?codigo=TecNM-ITSM-20251-116&ngrok=https://abc123.ngrok.io";
        echo "</div>";
        echo "</div>";
        
        echo "<h3>🧪 Pruebas con ngrok:</h3>";
        ...
        echo "<br>";
        echo "<h4>Prueba 2: Con ngrok (cuando esté configurado)</h4>";
        echo "<p>https://abc123.ngrok.io/Insignias_TecNM_Funcional/facebook_ngrok.php?codigo=$codigo_buscar&ngrok=https://abc123.ngrok.io</p>";
        echo "<p>Esta URL funcionará con Facebook una vez que configures ngrok.</p>";
        echo "<br>";
        ...
        echo "<p>Pega la URL de ngrok en el debugger para verificar que Facebook pueda acceder a ella.</p>";
        echo "</div>";
        ...
        echo "<h4 style='color: #155724; margin: 0;'>✅ SISTEMA LISTO PARA NGROK</h4>";
        echo "<p style='color: #155724; margin: 10px 0 0 0;'>El sistema está preparado para funcionar con ngrok. Una vez configurado, Facebook podrá acceder a la imagen.</p>";
        echo "</div>";
        ...
        echo "&lt;meta property=\"og:image\" content=\"https://abc123.ngrok.io/Insignias_TecNM_Funcional/imagen/insignia_Responsabilidad Social.png\"&gt;<br>";
        echo "&lt;meta property=\"og:image:secure_url\" content=\"https://abc123.ngrok.io/Insignias_TecNM_Funcional/imagen/insignia_Responsabilidad Social.png\"&gt;<br>";
        ...
        echo "&lt;meta property=\"og:url\" content=\"https://abc123.ngrok.io/Insignias_TecNM_Funcional/facebook_ngrok.php?codigo=TecNM-ITSM-20251-116&ngrok=https://abc123.ngrok.io\"&gt;<br>";
...
echo "<li>Descarga y configura ngrok siguiendo las instrucciones</li>";
echo "<li>Usa la URL de ngrok para compartir en Facebook</li>";
