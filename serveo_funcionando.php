...
echo "<h2>🎉 ¡serveo Funcionando! - URL Pública Lista</h2>";

$codigo_buscar = 'TecNM-ITSM-20251-116';
$serveo_url = 'https://07626ff413e86b0665634a29bd8ed90e.serveo.net';

echo "<p><strong>URL de serveo:</strong> $serveo_url</p>";
...
if ($result && $result->num_rows > 0) {
    ...
    if (file_exists($image_path)) {
        ...
        // Generar URLs con serveo
        $facebook_url = $serveo_url . '/Insignias_TecNM_Funcional/facebook_ngrok.php?codigo=' . urlencode($codigo_buscar) . '&ngrok=' . urlencode($serveo_url);
        $validation_url = $serveo_url . '/Insignias_TecNM_Funcional/validacion.php?insignia=' . urlencode($codigo_buscar);
        $image_url = $serveo_url . '/Insignias_TecNM_Funcional/imagen/insignia_Responsabilidad Social.png';
        
        echo "<h3>🔗 URLs Públicas con serveo:</h3>";
        echo "<ul>";
        echo "<li><a href='$facebook_url' target='_blank' style='color: #1877f2; font-weight: bold; font-size: 18px;'>facebook_ngrok.php (PARA FACEBOOK)</a></li>";
        ...
        echo "<h4>✅ ¡serveo está funcionando!</h4>";
        ...
        echo "<h3>📋 Meta tags generados (con serveo):</h3>";
        ...
        echo "<p style='color: #155724; margin: 10px 0 0 0;'>serveo está funcionando y Facebook puede acceder a la URL pública. El sistema está listo para usar.</p>";
        echo "</div>";
        
        echo "<h3>🔧 Comandos para mantener serveo activo:</h3>";
        echo "<div style='background: #fff3cd; padding: 20px; border-radius: 10px; margin: 20px 0; border-left: 4px solid #ffc107;'>";
        echo "<h4>Para mantener serveo funcionando:</h4>";
...
echo "<li>Mantén serveo activo en la terminal</li>";
