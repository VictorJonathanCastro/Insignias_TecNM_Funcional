<?php
/**
 * Funciones para envío de correos automáticos del sistema de insignias
 */
...
function enviarConPHPMailer($destinatario_email, $datos_insignia) {
    ...
    try {
        ...
        $tu_contraseña_app = "123456789"; // Cambia por tu contraseña de aplicación
        ...
        // Enviar el correo
        $mail->send();
        error_log("Correo enviado exitosamente con PHPMailer a: " . $destinatario_email);
        return true;
        
    } catch (Exception $e) {
        error_log("Error PHPMailer al enviar correo a " . $destinatario_email . ": " . $e->getMessage());
        return false;
    }
}
