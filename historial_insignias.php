...
// PRIORIDAD: Usar insigniasotorgadas primero (donde se guardan las nuevas insignias de carga masiva)
$usar_tabla_t = false;
$usar_tabla_i = false;

// Primero verificar insigniasotorgadas (donde se guardan las nuevas insignias de carga masiva)
try {
...
if (!$stmt) {
    die('Error al preparar la consulta: ' . $conexion->error . '<br>Tabla usada: ' . ($usar_tabla_i ? 'insigniasotorgadas' : 'T_insignias_otorgadas'));
}
