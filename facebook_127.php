...
// Generar URLs - usar 127.0.0.1 en lugar de ::1
...
$current_url = 'http://127.0.0.1' . $_SERVER['REQUEST_URI'];
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<body>
    <div class="container">
        ...
        <div class="facebook-warning">
            <h4>⚠️ Problema con Facebook:</h4>
            <p>Facebook no puede acceder a URLs de localhost (127.0.0.1 o ::1). Para que funcione, necesitas:</p>
            <ul>
                <li>1. Usar un servidor público (no localhost)</li>
                <li>2. O usar ngrok para crear un túnel público</li>
                <li>3. O subir el sistema a un hosting público</li>
            </ul>
        </div>
