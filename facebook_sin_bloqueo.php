...
// Generar URLs - usar IP local en lugar de localhost
...
$current_url = 'http://' . $server_ip . $_SERVER['REQUEST_URI'];
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<body>
    <div class="container">
        ...
        <div class="redirect-warning">
            <h4>⚠️ Solución para about:blank#blocked:</h4>
            <p>Si ves "about:blank#blocked", haz clic en el botón "Ver Certificado Completo" en lugar de hacer clic en la imagen.</p>
        </div>
        
        <div class="debug-info">
            <h4>🔧 Información de depuración:</h4>
            <p><strong>IP del servidor:</strong> <?php echo $server_ip; ?></p>
